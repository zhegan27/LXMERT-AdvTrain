...
class LXRTEncoder(nn.Module):
    ...
    def forward(self, sents, feats, adv_training, adv_modality, 
                adv_delta_txt, adv_delta_img, visual_attention_mask=None):
        ...
        output = self.model(input_ids, segment_ids, input_mask, feats, visual_attention_mask,
