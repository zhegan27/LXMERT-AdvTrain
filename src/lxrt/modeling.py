...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, adv_training=False, adv_modality=None, adv_delta=None):
...
class VisualFeatEncoder(nn.Module):
    ...
    def forward(self, visn_input, adv_training=False, adv_modality=None, adv_delta=None):
        feats, boxes = visn_input
        if adv_training == True and 'image' in adv_modality:
            feats = feats + adv_delta
...
class LXRTEncoder(nn.Module):
    ...
    def forward(self, lang_feats, lang_attention_mask,
                ...
                adv_training=False, adv_modality=None, adv_delta_img=None):
        # Run visual embedding layer
        # Note: Word embedding layer was executed outside this module.
        #       Keep this design to allow loading BERT weights.
        visn_feats = self.visn_fc(visn_feats, adv_training, adv_modality, adv_delta_img)
...
class LXRTModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,
                ...
                adv_training=False, adv_modality=None, adv_delta_txt=None, adv_delta_img=None):
        ...
        embedding_output = self.embeddings(input_ids, token_type_ids, adv_training, adv_modality, adv_delta_txt)
...
class LXRTFeatureExtraction(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, 
        ...
        feat_seq, pooled_output = self.bert(input_ids, token_type_ids, attention_mask, 
                                            visual_feats, visual_attention_mask,
